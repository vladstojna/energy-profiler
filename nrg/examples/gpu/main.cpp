...
struct power_query {
  ...
  static unit value(const nrgprf::reader_gpu &r, const nrgprf::sample &s,
                    uint32_t dev) {
...
get_readings(const nrgprf::reader_gpu &reader, const nrgprf::sample &first,
             const nrgprf::sample &last, uint8_t dev) {

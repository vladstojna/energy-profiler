...
reader_rapl::reader_rapl(location_mask dmask, socket_mask skt_mask,
                         std::ostream &os)
...
template <typename Location>
result<sensor_value> reader_rapl::value(const sample &s,
...
reader_rapl::values(const sample &s) const {

...
// The On Chip Controller (OCC) in Power9 systems supports the following
// locations: system, gpu, processor, memory. The processor location containes
// up to 3 sensors: package, vdd (cores) and vdn(nest/uncore) Unlike RAPL, there
// is no uncore sensor but there is an associated timestamp

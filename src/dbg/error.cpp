...
const char *dwarf_category_t::name() const noexcept { return "libdw"; }

std::string dwarf_category_t::message(int ev) const { return dwarf_errmsg(ev); }

std::error_condition
dwarf_category_t::default_error_condition(int) const noexcept {
  return tep::dbg::error_cause::dwarf_error;
}

const char *elf_category_t::name() const noexcept { return "libdw"; }

std::string elf_category_t::message(int ev) const { return elf_errmsg(ev); }

std::error_condition
elf_category_t::default_error_condition(int) const noexcept {
...
const std::error_category &elf_category() noexcept { return elf_category_v; }
